...
<head>
    ...
    <title>404 Eror - Lost and Alone</title>
    <link rel="stylesheet" href="{{asset('assets/css/404page.css')}}">
    ...
    <div class="container">
        <div class="left-section">
            <div class="inner-content">
                ...
                <p class="subheading">Có vẻ như trang bạn đang tìm kiếm không còn ở đây nữa.</p>
            </div>
        </div>
